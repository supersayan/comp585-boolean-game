...
function createDisplay(game) {
    ...
    if(game.expCompact[3] != undefined){
        game.goal3sprite = game.add.sprite(320,50, "attributes", getSprite(game.goal3.value));
        game.expressionText2 = game.add.text(230, 30, game.expCompact[3], fontStyle2);
        game.goal3sprite.setScale(0.4);
        game.goal3sprite.depth = 1;
        game.expressionText2.depth = 1;
    }
    if(game.expCompact[5] != undefined){
        game.goal4sprite = game.add.sprite(440,50, "attributes", getSprite(game.goal4.value));
        game.expressionText3 = game.add.text(360, 30, game.expCompact[5], fontStyle2);
