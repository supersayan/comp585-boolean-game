...
export default class Level1a extends MainGame {
    ...
    arrangeGrid ()
    {
        ...
        this.correctset.push(children[a].frame.customData.index)
        this.correctset.push(children[b].frame.customData.index)
        console.log(a,b)
        for (let i = 0; i < 16; i++)
        {
            if (i != a && i != b) {
                ...
                if (children[i].color == 'red' || children[i].color == 'blue') {
                    this.correctset.push(children[i].frame.customData.index)
                }
            }
        }
